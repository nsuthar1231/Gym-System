...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Update diet plan List</a> </div>
    <h1 class="text-center">Diet Plan List <i class="icon icon-cogs"></i></h1>
  </div>
