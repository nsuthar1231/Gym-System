...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="remove-equipment.php" class="current">Remove Diet Plan</a> </div>
    <h1 class="text-center">Diet Plan <i class="icon icon-cogs"></i></h1>
  </div>
  ...
  $result=mysqli_query($conn,$qry);
    ...
    echo"<table class='table table-bordered table-hover'>
      ...
      echo"<tbody> 
          ...
          <td><div class='text-center'>".$row['diet']."</div></td>
