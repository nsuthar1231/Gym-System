      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="edit-member-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              <label class="control-label">Diet Plan</label>
              <div class="controls">
                <input type="text"  class="span11" name="diet Plan" disabled="" placeholder="coco"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">workout Plan</label>
              <div class="controls">
                <input type="text"  class="span11" name="workout Plan" disabled="" placeholder="puchup"  />
              </div>
            </div>
            <div class="control-group">
