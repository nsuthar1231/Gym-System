...
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            //update query
            $qry = "update members set fullname='$fullname', username='$username',dor='$dor', gender='$gender', services='$services', amount='$amount', plan='$plan', address='$address', workout='$workout',contact='$contact' where user_id='$id'";
