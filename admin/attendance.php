                        ...
                        <table class='table table-bordered table-hover'>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                if ($res_attendance && $res_attendance->num_rows > 0) {
                                    ...
                                    echo "<div class='text-center'><a href='actions/delete-attendance.php?id={$row['user_id']}'><button class='btn btn-danger'>Check Out <i class='fas fa-clock'></i></button></a></div></td>";
                                } else {
...
<div class="row-fluid">
    <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Dhruv & Harsh</div>
</div>
